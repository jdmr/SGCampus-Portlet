...
<div class="Curso">
    ...
    <form:form name="contenidoForm" commandName="contenido" method="post" action="${actionUrl}" onSubmit="extractCodeFromEditor()" enctype="multipart/form-data" >
        ...
        <div class="dialog">
            <table>
                <tbody>
                    ...
                    <tr class="prop">
                        <td valign="top" class="name">
                            <label for="archivo"><liferay-ui:message key="contenido.video" /></label>
                        </td>
                        <td valign="top" class="value">
                            <input type="file" name="archivo" />
                            <form:errors cssClass="errors" path="archivo" cssStyle="color:red;" />
                        </td>
                    </tr>
